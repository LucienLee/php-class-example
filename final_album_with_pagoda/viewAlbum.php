...
<?php include('_site_header.php') ?>
  ...
  <div class="container">
    ...
    <div class="btn-group pull-right">
      <a href="newPhoto.php?albumid=<?= $data['ID'] ?>" class="btn">新增相片</a>
      <a href="editAlbum.php?albumid=<?= $data['ID'] ?>" class="btn">更新相簿</a>
      <a href="delete_album.php?albumid=<?= $data['ID'] ?>" class="btn btn-danger delete-album">刪除相簿</a>
    </div>
    <?php } ?>
